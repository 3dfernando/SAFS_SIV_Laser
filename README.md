...
# Shear Layer of a M=0.92 jet (dt=800 ns)

![Shear Layer](https://github.com/3dfernando/SAFS_SIV_Laser/tree/main/Samples/DoubleFrame_ShearLayer.gif)

# Boundary Layer of a M=0.91 plug nozzle (dt=800 ns)

![Shear Layer](https://github.com/3dfernando/SAFS_SIV_Laser/tree/main/Samples/DoubleFrame_Plug.gif)
